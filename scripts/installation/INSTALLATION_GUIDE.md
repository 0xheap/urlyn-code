# Installation Guide for Urlyn Code with Source Tracking

This guide describes how to install Node.js and Urlyn Code with source information tracking.

## Overview

The installation scripts automate the process of installing Node.js (if not present or below version 20) and Urlyn Code, while capturing and storing the installation source information for analytics and tracking purposes.
...
- Installs Urlyn Code globally with source information
...
1. The script accepts a `--source` parameter to specify where Urlyn Code is being installed from
2. It installs Node.js if needed
3. It installs Urlyn Code globally
...
This is required to load the newly installed Node.js and Urlyn Code into your PATH.
...
- Internet connection for downloading Node.js and Urlyn Code
...
1. The script accepts a `--source` or `-s` parameter to specify where Urlyn Code is being installed from
...
4. It installs Urlyn Code globally using npm
...
This feature implements the ability to capture and store the installation source of the Urlyn Code package. The source information is used for analytics and tracking purposes.
...
2. **Analytics**: Helps understand how users are discovering and installing Urlyn Code
...
- Ensure NVM is installed: `curl -o- https://urlyn-code-assets.oss-cn-hangzhou.aliyuncs.com/installation/install_nvm.sh | bash`
...
- The scripts require internet access to download Node.js and Urlyn Code
