...
} from '@urlyn-code/urlyn-code-core/src/ide/types.js';
import { detectIdeFromEnv } from '@urlyn-code/urlyn-code-core/src/ide/detect-ide.js';
...
const IDE_SERVER_PORT_ENV_VAR = 'URLYN_CODE_IDE_SERVER_PORT';
const IDE_WORKSPACE_PATH_ENV_VAR = 'URLYN_CODE_IDE_WORKSPACE_PATH';
const QWEN_DIR = '.qwen';
const IDE_DIR = 'ide';
...
const createMcpServer = (diffManager: DiffManager) => {
  const server = new McpServer(
    {
      name: 'urlyn-code-companion-mcp-server',
      version: '1.0.0',
    },
