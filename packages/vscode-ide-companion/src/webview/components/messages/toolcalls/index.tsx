 ...
 * All UI components are now imported from @urlyn-code/webui
 */
...
import type { BaseToolCallProps } from '@urlyn-code/webui';
...
export type { BaseToolCallProps, ToolCallData } from '@urlyn-code/webui';
