 ...
 * `urlyn-code:supportsSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'urlyn-code.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'urlyn-code.chatView.secondary';
