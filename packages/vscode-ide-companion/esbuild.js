...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    // @urlyn-code/urlyn-code-core is a peer dependency of @urlyn-code/webui.
    // Since @urlyn-code/webui marks it as external in its own Vite build, the
    ...
    external: ['@urlyn-code/urlyn-code-core'],
    logLevel: 'silent',
