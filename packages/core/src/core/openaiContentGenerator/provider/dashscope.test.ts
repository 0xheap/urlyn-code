  ...
  describe('buildHeaders', () => {
    it('should build DashScope-specific headers', () => {
      ...
      expect(headers).toEqual({
        ...
        'X-DashScope-UserAgent': `UrlynCode/1.0.0 (${process.platform}; ${process.arch})`,
    ...
    it('should merge custom headers with DashScope defaults', () => {
      ...
      expect(headers['User-Agent']).toContain('UrlynCode/1.0.0');
      expect(headers['X-DashScope-UserAgent']).toContain('UrlynCode/1.0.0');
