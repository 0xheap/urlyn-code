...
import type { Config, ChatRecord } from '@urlyn-code/urlyn-code-core';
import type {
  InsightData,
  SessionFacets,
...
vi.mock('@urlyn-code/urlyn-code-core', async () => {
  const actual = await vi.importActual<
    typeof import('@urlyn-code/urlyn-code-core')
...
import { read as readJsonlFile } from '@urlyn-code/urlyn-code-core';
