...
import { IdeClient } from '@urlyn-code/urlyn-code-core';
...
describe('systemInfo', () => {
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@urlyn-code/urlyn-code-core');
