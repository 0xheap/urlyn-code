...
// Portuguese translations for Urlyn Code CLI (pt-BR)
...
export default {
  ...
  'List available Urlyn Code tools. Usage: /tools [desc]':
    'Listar ferramentas Urlyn Code disponíveis. Uso: /tools [desc]',
  'List available skills.': 'Listar habilidades disponíveis.',
  'Available Urlyn Code CLI tools:':
    'Ferramentas CLI do Urlyn Code disponíveis:',
  ...
  'open full Urlyn Code documentation in your browser':
    'abrir documentação completa do Urlyn Code no seu navegador',
  ...
  'Generate with Urlyn Code (Recommended)':
    'Gerar com Urlyn Code (Recomendado)',
  ...
  'View and edit Urlyn Code settings':
    'Ver e editar configurações do Urlyn Code',
  Settings: 'Configurações',
  'To see changes, Urlyn Code must be restarted. Press r to exit and apply changes now.':
    'Para ver as alterações, o Urlyn Code deve ser reiniciado. Pressione r para sair e aplicar as alterações agora.',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Urlyn Code.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o Urlyn Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Urlyn Code in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o Urlyn Code em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Urlyn Code hooks': 'Gerenciar hooks do Urlyn Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Urlyn Code.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao Urlyn Code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Urlyn Code.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao Urlyn Code.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  System: 'Sistema',
  ...
  'Right before Urlyn Code concludes its response':
    'Logo antes do Urlyn Code concluir sua resposta',
  ...
  "Urlyn Code won't ask before using allowed tools.":
    'O Urlyn Code não perguntará antes de usar ferramentas permitidas.',
  'Urlyn Code will ask before using these tools.':
    'O Urlyn Code perguntará antes de usar essas ferramentas.',
  'Urlyn Code is not allowed to use denied tools.':
    'O Urlyn Code não tem permissão para usar ferramentas negadas.',
  ...
  'Urlyn Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'O Urlyn Code pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'Urlyn Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O Urlyn Code poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from Urlyn Code using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do Urlyn Code usando ! (ex: !ls).',
