...
// Русский перевод для Urlyn Code CLI
...
export default {
  ...
  'List available Urlyn Code tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов Urlyn Code. Использование: /tools [desc]',
  'List available skills.': 'Показать доступные навыки.',
  'Available Urlyn Code CLI tools:': 'Доступные инструменты Urlyn Code CLI:',
  ...
  'open full Urlyn Code documentation in your browser':
    'Открытие полной документации Urlyn Code в браузере',
  ...
  'Generate with Urlyn Code (Recommended)':
    'Сгенерировать с помощью Urlyn Code (Рекомендуется)',
  ...
  'View and edit Urlyn Code settings':
    'Просмотр и изменение настроек Urlyn Code',
  Settings: 'Настройки',
  'To see changes, Urlyn Code must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить Urlyn Code. Нажмите r для выхода и применения изменений.',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Urlyn Code.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с Urlyn Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Urlyn Code in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите Urlyn Code в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Urlyn Code hooks': 'Управлять хуками Urlyn Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Urlyn Code.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите Urlyn Code.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Urlyn Code.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите Urlyn Code.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  System: 'Система',
  ...
  'Right before Urlyn Code concludes its response':
    'Непосредственно перед завершением ответа Urlyn Code',
  ...
  "Urlyn Code won't ask before using allowed tools.":
    'Urlyn Code не будет спрашивать перед использованием разрешённых инструментов.',
  'Urlyn Code will ask before using these tools.':
    'Urlyn Code спросит перед использованием этих инструментов.',
  'Urlyn Code is not allowed to use denied tools.':
    'Urlyn Code не может использовать запрещённые инструменты.',
  ...
  'Urlyn Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'Urlyn Code может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'Urlyn Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'Urlyn Code сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'files to customize your interactions with Urlyn Code.':
    'файлы для настройки взаимодействия с Urlyn Code.',
  ...
  'You can run any shell commands from Urlyn Code using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в Urlyn Code с помощью ! (например, !ls).',
