...
// Chinese translations for Urlyn Code CLI
...
export default {
  ...
  'for help on Urlyn Code': '获取 Urlyn Code 帮助',
  'show version info': '显示版本信息',
  'submit a bug report': '提交错误报告',
  'About Urlyn Code': '关于 Urlyn Code',
  Status: '状态',
  ...
  'List available Urlyn Code tools. Usage: /tools [desc]':
    '列出可用的 Urlyn Code 工具。用法：/tools [desc]',
  'List available skills.': '列出可用技能。',
  'Available Urlyn Code CLI tools:': '可用的 Urlyn Code CLI 工具：',
  ...
  'Generate with Urlyn Code (Recommended)': '使用 Urlyn Code 生成（推荐）',
  ...
  // ============================================================================
  'View and edit Urlyn Code settings': '查看和编辑 Urlyn Code 设置',
  Settings: '设置',
  'To see changes, Urlyn Code must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 Urlyn Code。按 r 退出并立即应用更改。',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Urlyn Code.':
    '您正在安装来自 {{originSource}} 的扩展。某些功能可能无法完美兼容 Urlyn Code。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Urlyn Code in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 Urlyn Code：VS Code 或 VS Code 分支版本。',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Urlyn Code hooks': '管理 Urlyn Code Hook',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Urlyn Code.':
    '此菜单为只读。要添加或修改 Hook，请直接编辑 settings.json 或询问 Urlyn Code。',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Urlyn Code.':
    '要重新启用 Hook，请从 settings.json 中删除 "disableAllHooks" 或询问 Urlyn Code。',
  // Hooks - Source
  Project: '项目',
  User: '用户',
  System: '系统',
  ...
  'Right before Urlyn Code concludes its response': 'Urlyn Code 结束响应之前',
  ...
  'You can run any shell commands from Urlyn Code using ! (e.g. !ls).':
    '在 Urlyn Code 中使用 ! 可运行任意 shell 命令（例如 !ls）。',
  ...
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'Urlyn Code 正在关闭，再见！',
