...
// Add Urlyn Code specific entries to .gitignore file
...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    const readmeUrl = `https://github.com/QwenLM/urlyn-code-action/blob/${releaseTag}/README.md#quick-start`;
    ...
    for (const workflow of GITHUB_WORKFLOW_PATHS) {
      downloads.push(
        (async () => {
          const endpoint = `https://raw.githubusercontent.com/QwenLM/urlyn-code-action/refs/tags/${releaseTag}/examples/workflows/${workflow}`;
