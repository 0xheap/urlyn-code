...
import { FatalConfigError, ideContextStore } from '@urlyn-code/urlyn-code-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use URLYN_CODE_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['URLYN_CODE_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['URLYN_CODE_TRUSTED_FOLDERS_PATH'];
  });
