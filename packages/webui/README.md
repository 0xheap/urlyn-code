...
A shared React component library for Urlyn Code applications, providing cross-platform UI components with consistent styling and behavior.
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@urlyn-code/webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@urlyn-code/webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
    ...
    <script type="text/babel">
      // Access components from the global UrlynCodeWebUI object
      const { ChatViewer } = UrlynCodeWebUI;
...
```tsx
import { Button, Input, Tooltip } from '@urlyn-code/webui';
import { PlatformProvider } from '@urlyn-code/webui/context';
...
```tsx
import { Button } from '@urlyn-code/webui';
...
```tsx
import { Input } from '@urlyn-code/webui';
...
```tsx
import { Tooltip } from '@urlyn-code/webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@urlyn-code/webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@urlyn-code/webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@urlyn-code/webui/tailwind.preset.cjs')],
  // your customizations
};
```
