...
#### 1、Clone urlyn code project first, https://github.com/QwenLM/urlyn-code.git
...
# 2. Build the Urlyn Code project
npm run build
...
ls -la $(dirname $(which qwen))/../lib/node_modules/@urlyn-code/urlyn-code
...
- Official mirror image address:https://github.com/QwenLM/urlyn-code/pkgs/container/urlyn-code

```bash
# Based on the official Qwen sandbox image (It is recommended to explicitly specify the version)
FROM ghcr.io/qwenlm/urlyn-code:sha-570ec43
...
npm unlink -g @urlyn-code/urlyn-code
