...
This document describes the `save_memory` tool for Urlyn Code.

## Description

Use `save_memory` to save and recall information across your Urlyn Code sessions. With `save_memory`, you can direct the CLI to remember key details across sessions, providing personalized and directed assistance.
...
## How to use `save_memory` with Urlyn Code
...
```
save_memory(fact="The project I'm currently working on is called 'urlyn-code'.")
```
