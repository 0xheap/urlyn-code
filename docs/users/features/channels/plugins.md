...
You can extend the channel system with custom platform adapters packaged as [extensions](../../extension/introduction). This lets you connect Urlyn Code to any messaging platform, webhook, or custom transport.
