...
> Create, manage, and share Skills to extend Urlyn Code's capabilities.

This guide shows you how to create, use, and manage Agent Skills in **Urlyn Code**. Skills are modular capabilities that extend the model's effectiveness through organized folders containing instructions (and optionally scripts/resources).

## Prerequisites

- Urlyn Code (recent version)
- Basic familiarity with Urlyn Code ([Quickstart](../quickstart.md))
...
- Extend Urlyn Code for your workflows
...
## Instructions
Provide clear, step-by-step guidance for Urlyn Code.
...
Urlyn Code currently validates that:
...
Urlyn Code discovers Skills from:
...
To view available Skills, ask Urlyn Code directly:
...
If Urlyn Code doesn't use your Skill, check these common issues:
...
Run Urlyn Code with debug mode to see Skill loading errors:
...
Changes take effect the next time you start Urlyn Code. If Urlyn Code is already running, restart it to load the updates.
