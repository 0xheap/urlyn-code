...
<head>
  ...
  <title>Urlyn Code Chat Export</title>
  ...
  <script src="https://unpkg.com/@urlyn-code/webui@0.1.0-beta.4/dist/index.umd.js"></script>

  <!-- Load the CSS -->
  <link rel="stylesheet" href="https://unpkg.com/@urlyn-code/webui@0.1.0-beta.4/dist/styles.css">
...
<body>
  ...
  <script>
    ...
    const { ChatViewer, PlatformProvider } = UrlynCodeWebUI;
