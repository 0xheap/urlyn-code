 ...
 *
 * Tests the actual MockPluginChannel (from @urlyn-code/channel-plugin-example) connected
 ...
 *           → urlyn-code --acp (REAL model request)
...
describe('Channel Plugin (Mock WebSocket E2E)', () => {
  ...
  const setup = async () => {
    ...
    // 2. Start AcpBridge (spawns real urlyn-code --acp)
